...
# ==============================================================================
# 200k Animal Husbandry & Compound Pasture Engine (v5/main.py & main.py)
# ==============================================================================
#
...
def build_tasks(
    ...
    for y, row in enumerate(tiles):
        for x, tile in enumerate(row):
            ...
            if kind == "COOP":
                has_coop = True
                # Animal feed & fertilizer collection tasks
            ...
            if is_free(tile):
                # Construct Coop & Pasture on empty corner tiles in early game
                if day <= 4:
